        ...
        Row(
          children: [
            Expanded(
              child: TextField(
                controller: _filter,
                cursorColor: MyColors.mainTheme,
                style: TextStyle(
                    fontFamily: MyFont.myFont, color: MyColors.mainTheme),
                decoration: InputDecoration(
                  filled: true,
                  fillColor: MyColors.regColor,
                  hintText: 'Search',
                  hintStyle:
                      TextStyle(fontFamily: MyFont.myFont, color: Colors.grey),
                  ...
                  enabledBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(10.0),
                    borderSide: const BorderSide(color: MyColors.regColor),
                  ),
                ),
              ),
            ),
